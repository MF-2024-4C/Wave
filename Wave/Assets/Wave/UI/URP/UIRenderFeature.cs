...
namespace Wave.UI
{
    public class UIRendererFeature : ScriptableRendererFeature
    {
        ...
        [SerializeField] private bool _execblur = false;
        [SerializeField] private bool _execGlassMorphism = false;

        [SerializeField] [Range(0.0f, 1.0f)] private float _blurRate = 1.0f;
        [SerializeField] [Range(0.5f, 3.0f)] private float _blurWidth = 2.0f;
