...
namespace GizmosUtility.Editor
{
    public static class GizmosExtensions
    {
            ...
            Quaternion rotation = default(Quaternion))
        {
            ...
            if (rotation.Equals(default(Quaternion)))
                rotation = Quaternion.identity;
            Gizmos.matrix = Matrix4x4.TRS(center, rotation, new Vector3(1, GizmoDiskThickness, 1));
            ...
            int layerMask, bool showCast)
        {
            ...
            if (showCast && Physics.BoxCast(center, halfExtents, direction, out RaycastHit hitInfo, orientation,
