...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(0.927083,0.927083,0.927083,1.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.927083,0.927083,0.927083,0.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	PixelMaterialInputs.Opacity = Local13.rgb;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local8;
	PixelMaterialInputs.Metallic = 0.00000000;
	PixelMaterialInputs.Specular = 0.50000000;
	PixelMaterialInputs.Roughness = Local10.g;
